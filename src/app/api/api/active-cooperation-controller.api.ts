...
import {
    ActiveCooperationControllerServiceInterface,
    GetInfluencersToAcceptRequestParams,
    GetInfluencersToRateRequestParams,
    GetOpportunitiesInProgressRequestParams,
    UpdateCompanyRating1RequestParams,
    UpdateInfluencerRating1RequestParams
} from './active-cooperation-controller.apiInterface';
...
export class ActiveCooperationControllerService implements ActiveCooperationControllerServiceInterface {
    ...
    public getInfluencersToAccept(requestParameters?: GetInfluencersToAcceptRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (minFollowers !== undefined && minFollowers !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>minFollowers, 'minFollowers');
        }
        if (maxFollowers !== undefined && maxFollowers !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>maxFollowers, 'maxFollowers');
        }
        if (minPositiveRates !== undefined && minPositiveRates !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>minPositiveRates, 'minPositiveRates');
        }
        ...
        let localVarPath = `/activecoop/accept`;
        return this.httpClient.request<Array<CoopDtoRegistration>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
    ...
    public getInfluencersToRate(requestParameters?: GetInfluencersToRateRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarQueryParameters = new HttpParams({encoder: this.encoder});
        if (filterRateStatus !== undefined && filterRateStatus !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>filterRateStatus, 'filterRateStatus');
        }
        if (page !== undefined && page !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>page, 'page');
        ...
        let localVarPath = `/activecoop/rate`;
        return this.httpClient.request<Array<CoopDtoRatings>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public updateCompanyRating1(requestParameters: UpdateCompanyRating1RequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (rating === null || rating === undefined) {
            throw new Error('Required parameter rating was null or undefined when calling updateCompanyRating1.');
        }
    ...
    public updateInfluencerRating1(requestParameters: UpdateInfluencerRating1RequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        const rating = requestParameters?.rating;
        if (rating === null || rating === undefined) {
            throw new Error('Required parameter rating was null or undefined when calling updateInfluencerRating1.');
        }
