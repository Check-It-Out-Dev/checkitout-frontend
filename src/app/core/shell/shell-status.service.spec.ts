...
describe('ShellStatusService', () => {
  ...
  describe('noteResponseHeaders', () => {
    ...
    // subsumed-by: shell-status.service.spec.ts :: ShellStatusService noteResponseHeaders flips consentRequired when X-Consent-Required is "1", shell-headers.interceptor.spec.ts :: shellHeadersInterceptor forwards X-Email-Verification-Required to the shell-status service (round 1)
    subsumed(it)(
