...
[![code scanning](https://github.com/Check-It-Out-Dev/checkitout-frontend/actions/workflows/code-scanning.yml/badge.svg)](https://github.com/Check-It-Out-Dev/checkitout-frontend/actions/workflows/code-scanning.yml)
...
| [`code-scanning.yml`](.github/workflows/code-scanning.yml)           | push, pull request, weekly       | CodeQL over the application and the workflow files themselves, plus a dependency review that fails a pull request introducing a known high-severity advisory.                                                                                                                                                       | ~8 min        |
...
| ✅  | Nightly full-stack run on a schedule                     | 02:00 UTC against the published backend image                                                                                                                            |
...
| ✅  | Secret scanning, push protection, CodeQL                 | Enabled 2026-09-11 after a credential was found in the backend's test corpus; dependency review fails a pull request that adds a high-severity advisory                  |
