...
```
Error: send-verification-email failed: HTTP 401 (attempt 1/3): {"timestamp":"2026-09-10T22:00:36.304","status":401,"error":"Unauthorized","message":"User not authenticated","path":"/api/auth/send-verification-email","requestId":"REQ-ecbd5b05","messageKey":"error.
```
