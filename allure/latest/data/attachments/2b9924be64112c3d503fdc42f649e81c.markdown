...
```
Error: send-verification-email failed: HTTP 401 (attempt 1/3): {"timestamp":"2026-09-10T22:00:37.564","status":401,"error":"Unauthorized","message":"User not authenticated","path":"/api/auth/send-verification-email","requestId":"REQ-6e2d85ed","messageKey":"error.
```
